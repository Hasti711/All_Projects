...
<body>
  ...
  <header>
        ...
        <div class="collapse navbar-collapse" id="navbarSupport">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              ...
              <% 
                    if (Session["update"].ToString() == "donor")
                    {
                    %>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link" href="blood_bank.aspx" target="_top">Blood Bank</a>
            </li>
            <li class="nav-item">
            ...
            { %>
              ...
              <li class="nav-item">
                  <%
                      if(Session["u_email"] == null)
            { %>
                          <a class="nav-link" href="#" target="_top"></a>
            <%}
    ...
    <% }
        ...
        {
        %>
                  <a class="nav-link" href="b_register.aspx" target="_top">Profile</a> <% } %>
              </li>
          </ul>
        </div> <!-- .navbar-collapse -->
      </div> <!-- .container -->
    ...
    <div class="hero-section">
      <div class="container text-center wow zoomIn">
        ...
        <a href="donor_form.aspx" target="_top" class="btn btn-primary">Let's Consult</a>
      </div>
    </div>
  </div>
