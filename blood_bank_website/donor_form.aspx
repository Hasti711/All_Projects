      ...
      <form id="d_form" runat="server" class="main-form">
        <div class="row mt-5 ">
          ...
          <div class="col-12 col-sm-6 py-2 wow fadeInLeft">
            <input type="text" runat="server" id="d_b_bk" class="form-control" placeholder="Blood Bank Name">
          </div>
        </div>

        <button type="submit" runat="server" id="d_f_btn" onserverclick="d_f_fun" class="btn btn-primary mt-3 wow zoomIn">Donate</button>
      </form>
    </div>
  </div> <!-- .page-section --><% } %>
    <asp:Label runat="server" ID="d_f_lb" />
