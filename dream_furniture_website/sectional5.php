...
<div class=app-figure id=zoom-fig>
        <a id=spin-1 class=Magic360 data-options=rows: 4; columns: 12
            href="images/Home/Living/Sofa/Sectional/s1/s10-01-01.png"
        ><img src="images/Home/Living/Sofa/Sectional/s1/s10-01-01.png"></a>
    </div>
<?php
...
/*if($retval1)
{
    while ($r1 = mysqli_fetch_row($retval1)) {
        # code...
        //echo $r1[0];
        //echo "<img src = ".$r1[1].">";
        echo '<div class=app-figure id= zoom-fig >
        <a id= spin-1 class= Magic360 data-options= rows: 4; columns: 12 href= $r1[1]>
              "<img src ="'.$r1[1].'">"
            </a>
            </div>';
    }
