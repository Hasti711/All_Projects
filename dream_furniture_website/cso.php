...
function color()
{
    ...
    if(!isset($_POST['change']))
    {
            ...
            <label><input type='radio' name='ccolor' value='2'><img src=images/a49.jpg></label>
            <label><input type='radio' name='ccolor' value='3'><img src=images/a55.jpg></label>";
        $r=mysqli_query($conn,"select * from fur where Fnm='Sofa' and Ftype='Ottoman' and Ftnm='corner sloan' and Fcolor='White'");
        if($r)
        {
    ...
    else
    {
        ...
        {
            $r=mysqli_query($conn,"select * from fur where Fnm='Sofa' and Ftype='Ottoman' and Ftnm='corner sloan' and Fcolor='brown'");
            if($r)
            {
                ...
                <label><input type='radio' name='ccolor' value='2' checked><img src=images/a49.jpg></label>
                <label><input type='radio' name='ccolor' value='3'><img src=images/a55.jpg></label>";
                while($row=mysqli_fetch_array($r))
                {
                    echo "<div class=app-figure id=zoom-fig>
        ...
        {
            $r=mysqli_query($conn,"select * from fur where Fnm='Sofa' and Ftype='Ottoman' and Ftnm='corner sloan' and Fcolor='black'");
            if($r)
            {
                $var= "<br><br><br><h3>To Choose Color click on it and then click on submit<br><br></h3><label><input type='radio' name='ccolor' value='1'><img src=images/a.jpg></label>
                <label><input type='radio' name='ccolor' value='2'><img src=images/a49.jpg></label>
                <label><input type='radio' name='ccolor' value='3' checked><img src=images/a55.jpg></label>";
                while($row=mysqli_fetch_array($r))
                {
                    echo "<div class=app-figure id=zoom-fig>
            <a id=spin-1 class=Magic360 data-options=rows: 4; columns: 12
