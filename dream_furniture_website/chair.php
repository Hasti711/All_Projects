...
<div class="_1HmYoV _35HD7C" style="flex: 0 0 160px; max-width: 280px;  padding: 0px 10px 0px 0px;">
		<ul><!-- class="nav navbar-nav w3ls-nav1 text-center" -->
			...
			<li>
				...
				<div id="p3">
					<ol>
					<li><a href="table.php" class="lc"><img src="images/arrow.png" style="height: 23px; width: 23px;">Dinning Table</a></li>
					</ol>
				</div>
			</li><br>
			<li>
...
<div class="_1HmYoV _35HD7C" style="flex-grow: 1; overflow: auto">
  	...
  	<tr>
		<td>
<a href="chair1.php" class="lc">
			<div class="flex-container">
			<div style="flex-grow: 1"> <img src="<?php
$sql1="select * from fur where ftype='chair' && ftnm='andrew' && fcolor='gray'";
...
?>
		...
		<td><a href="chair2.php" class="lc">
			<div class="flex-container">
			<div style="flex-grow: 1"> <img src="<?php
$sql1="select * from fur where ftype='chair' && ftnm='dylan' && fcolor='gray'";
$r=mysqli_query($conn,$sql1);
if($r)
{
...
<td><a href="chair3.php" class="lc">
			<div class="flex-container">
			<div style="flex-grow: 1"> <img src="<?php
$sql1="select * from fur where ftype='chair' && ftnm='kit' && fcolor='gray'";
$r=mysqli_query($conn,$sql1);
if($r)
{
	while ($row=mysqli_fetch_array($r)) {
