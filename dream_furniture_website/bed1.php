...
function color()
{
    ...
    {
            $var= "<br><br><br><label><input type='radio' name='ccolor' value='1' checked><img src=images/a23.jpg></label>
        ...
        $r=mysqli_query($conn,"select * from fur where Fnm='Bed' and Ftype='queen' and Ftnm='harper' and Fcolor='blue'");
        if($r)
        {
    ...
    else
    {
        ...
        {
            $r=mysqli_query($conn,"select * from fur where Fnm='bed' and Ftype='queen' and Ftnm='harper' and Fcolor='gray'");
            if($r)
            {
                $var= "<br><br><br><label><input type='radio' name='ccolor' value='1'><img src=images/a23.jpg></label>
        ...
        {
            $r=mysqli_query($conn,"select * from fur where Fnm='bed' and Ftype='queen' and Ftnm='harper' and Fcolor='White'");
            if($r)
            {
                $var= "<br><br><br><label><input type='radio' name='ccolor' value='1'><img src=images/a23.jpg></label>
                <label><input type='radio' name='ccolor' value='2'><img src=images/a54.jpg></label>
