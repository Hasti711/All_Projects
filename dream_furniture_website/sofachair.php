...
<div class="_1HmYoV _35HD7C" style="flex-grow: 1;
    overflow: auto">
  	...
  	<tr>
		<td>
<a href="sofachair1.php" class="lc">
			<div class="flex-container">
			<div style="flex-grow: 1"> <img src="<?php
$sql1="select * from fur where ftype='sofa chair' && ftnm='sloan' && fcolor='black'";
...
?>
		...
		<td><a href="sofachair2.php" class="lc">
			<div class="flex-container">
			<div style="flex-grow: 1"> <img src="<?php
$sql1="select * from fur where ftype='sofa chair' && ftnm='gray' && fcolor='gold'";
$r=mysqli_query($conn,$sql1);
if($r)
{
...
<tr><td><a href="sofachair3.php" class="lc">
			<div class="flex-container">
			<div style="flex-grow: 1"> <img src="<?php
$sql1="select * from fur where ftype='sofa chair' && ftnm='charly' && fcolor='black'";
$r=mysqli_query($conn,$sql1);
if($r)
{
	while ($row=mysqli_fetch_array($r)) {
...
</td>	<td><a href="sofachair4.php" class="lc">
			<div class="flex-container">
			<div style="flex-grow: 1"> <img src="<?php
$sql1="select * from fur where ftype='sofa chair' && ftnm='tegan' && fcolor='lb'";
$r=mysqli_query($conn,$sql1);
if($r)
{
	while ($row=mysqli_fetch_array($r)) {
