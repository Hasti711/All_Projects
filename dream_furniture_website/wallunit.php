...
<div class="_1HmYoV _35HD7C" style="flex-grow: 1;
    overflow: auto">
  	...
  	<tr>
		<td>
<a href="wallunit1.php" class="lc">
			<div class="flex-container">
			<div style="flex-grow: 1"> <img src="<?php
$sql1="select * from fur where ftype='wu1' && ftnm='wu1'";
...
?>
		...
		<td><a href="wallunit2.php" class="lc">
			<div class="flex-container">
			<div style="flex-grow: 1"> <img src="<?php
$sql1="select * from fur where ftype='wu1' && ftnm='wu2'";
$r=mysqli_query($conn,$sql1);
if($r)
{
...
?>
		...
		<tr><td><a href="wallunit3.php" class="lc">
			<div class="flex-container">
			<div style="flex-grow: 1"> <img src="<?php
$sql1="select * from fur where ftype='wu1' && ftnm='wu3'";
$r=mysqli_query($conn,$sql1);
if($r)
{
	while ($row=mysqli_fetch_array($r)) {
...
if($r)
{
	...
	echo 'Rs '.$row["Fprice"];
		...
		<td><a href="wallunit4.php" class="lc">
			<div class="flex-container">
			<div style="flex-grow: 1"> <img src="<?php
