...
<div class="_1HmYoV _35HD7C" style="flex-grow: 1;
    overflow: auto">
  	...
  	<tr>
		<td>
<a href="ottoman1.php" class="lc">
			<div class="flex-container">
			<div style="flex-grow: 1"> <img src="<?php
$sql1="select * from fur where ftype='ottoman' && ftnm='owens' && fcolor='red'";
...
?>
		...
		<td><a href="ottoman2.php" class="lc">
			<div class="flex-container">
			<div style="flex-grow: 1"> <img src="<?php
$sql1="select * from fur where ftype='ottoman' && ftnm='oliver' && fcolor='red'";
$r=mysqli_query($conn,$sql1);
if($r)
{
...
<tr><td><a href="ottoman3.php" class="lc">
			<div class="flex-container">
			<div style="flex-grow: 1"> <img src="<?php
$sql1="select * from fur where ftype='ottoman' && ftnm='maxwell sill covered' && fcolor='white'";
$r=mysqli_query($conn,$sql1);
if($r)
{
	while ($row=mysqli_fetch_array($r)) {
...
</td><td><a href="ottoman5.php" class="lc">
			<div class="flex-container">
			<div style="flex-grow: 1"> <img src="<?php
$sql1="select * from fur where ftype='ottoman' && ftnm='charly' && fcolor='brown'";
$r=mysqli_query($conn,$sql1);
if($r)
{
	while ($row=mysqli_fetch_array($r)) {
