...
<body>
<div class="_1HmYoV">
<div class="_1HmYoV _35HD7C" style="flex: 0 0 280px; max-width: 280px;  padding: 0px 10px 0px 0px;">
...
<div class="_1HmYoV _35HD7C" style="flex-grow: 1;
    overflow: auto">
  	<table border="1" width="250px" height="100px">
  	<tr>
		<td>
<a href="sectional1.php" class="lc">
			<div class="flex-container">
			<div style="flex-grow: 1"> <img src="<?php
$sql1="select * from fur where ftype='sectional' && ftnm='maxwell' && fcolor='white'";
...
?>
		...
		<td><a href="sectional2.php" class="lc">
			<div class="flex-container">
			<div style="flex-grow: 1"> <img src="<?php
$sql1="select * from fur where ftype='sectional' && ftnm='jason wu' && fcolor='white'";
$r=mysqli_query($conn,$sql1);
if($r)
{
...
?>
	...
	<tr><td><a href="sectional3.php" class="lc">
			<div class="flex-container">
			<div style="flex-grow: 1"> <img src="<?php
$sql1="select * from fur where ftype='sectional' && ftnm='corner sloan' && fcolor='white'";
$r=mysqli_query($conn,$sql1);
if($r)
{
	while ($row=mysqli_fetch_array($r)) {
...
if($r)
{
	...
	<td><a href="sectional4.php" class="lc">
			<div class="flex-container">
			<div style="flex-grow: 1"> <img src="<?php
$sql1="select * from fur where ftype='sectional' && ftnm='ms chesterfield' && fcolor='gray'";
$r=mysqli_query($conn,$sql1);
if($r)
{
	while ($row=mysqli_fetch_array($r)) {
