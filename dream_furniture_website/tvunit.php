...
<div class="_1HmYoV _35HD7C" style="flex-grow: 1;
    overflow: auto">
  	...
  	<tr>
		<td>
<a href="tvunit1.php" class="lc">
			<div class="flex-container">
			<div style="flex-grow: 1"> <img src="<?php
$sql1="select * from fur where ftype='tv1' && ftnm='tv1'";
...
?>
		...
		<td><a href="tvunit2.php" class="lc">
			<div class="flex-container">
			<div style="flex-grow: 1"> <img src="<?php
$sql1="select * from fur where ftype='tv1' && ftnm='tv2'";
$r=mysqli_query($conn,$sql1);
if($r)
{
...
?>
	...
	<tr><td><a href="tvunit3.php" class="lc">
			<div class="flex-container">
			<div style="flex-grow: 1"> <img src="<?php
$sql1="select * from fur where ftype='tv1' && ftnm='tv3'";
$r=mysqli_query($conn,$sql1);
if($r)
{
	while ($row=mysqli_fetch_array($r)) {
...
if($r)
{
	...
	<td><a href="tvunit4.php" class="lc">
			<div class="flex-container">
			<div style="flex-grow: 1"> <img src="<?php
$sql1="select * from fur where ftype='tv1' && ftnm='tv4'";
$r=mysqli_query($conn,$sql1);
if($r)
{
	while ($row=mysqli_fetch_array($r)) {
