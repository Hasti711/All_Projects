...
function color()
{
    ...
    {
            $var= "<input type='radio' name='ccolor' value='1' checked>White
            <input type='radio' name='ccolor' value='2'>Black
            <input type='radio' name='ccolor' value='3'>Red";
        $r=mysqli_query($conn,"select * from fur where Fnm='Sofa' and Ftype='Ottoman' and Ftnm='maxwell sill covered' and Fcolor='White'");
        if($r)
        {
    ...
    else
    {
        ...
        {
            $r=mysqli_query($conn,"select * from fur where Fnm='Sofa' and Ftype='Ottoman' and Ftnm='maxwell sill covered' and Fcolor='Black'");
            if($r)
            {
                $var= "<input type='radio' name='ccolor' value='1'>White
        ...
        {
            $r=mysqli_query($conn,"select * from fur where Fnm='Sofa' and Ftype='Ottoman' and Ftnm='maxwell sill covered' and Fcolor='Red'");
            if($r)
            {
                $var= "<input type='radio' name='ccolor' value='1'>White
                <input type='radio' name='ccolor' value='2'>Black
