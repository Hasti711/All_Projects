...
function color()
{
    ...
    if(!isset($_POST['change']))
    {
        ...
        $r=mysqli_query($conn,"select * from fur where Fnm='Sofa' and Ftype='Ottoman' and Ftnm='sloan' and Fcolor='Black'");
        if($r)
        {
    ...
    else
    {
        ...
        {
            $r=mysqli_query($conn,"select * from fur where Fnm='Sofa' and Ftype='Ottoman' and Ftnm='sloan' and Fcolor='Brown'");
            if($r)
            {
        ...
        {
            $r=mysqli_query($conn,"select * from fur where Fnm='Sofa' and Ftype='Ottoman' and Ftnm='sloan' and Fcolor='red'");
            if($r)
            {
                $var= "<input type='radio' name='ccolor' value='1'>Black
                <input type='radio' name='ccolor' value='2'>Brown
