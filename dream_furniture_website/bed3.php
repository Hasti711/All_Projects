...
function color()
{
    ...
    if(!isset($_POST['change']))
    {
            ...
            <label><input type='radio' name='ccolor' value='2'><img src=images/a57.jpg></label>
            <label><input type='radio' name='ccolor' value='3'><img src=images/a2.jpg></label>";
        $r=mysqli_query($conn,"select * from fur where Fnm='Bed' and Ftype='queen' and Ftnm='gray' and Fcolor='black'");
        if($r)
        {
    ...
    else
    {
        ...
        {
            $r=mysqli_query($conn,"select * from fur where Fnm='bed' and Ftype='queen' and Ftnm='gray' and Fcolor='gray'");
            if($r)
            {
                $var= "<br><br><br><label><input type='radio' name='ccolor' value='1'><img src=images/a23.jpg></label>
                <label><input type='radio' name='ccolor' value='2' checked><img src=images/a57.jpg></label>
                <label><input type='radio' name='ccolor' value='3'><img src=images/a2.jpg></label>";
                while($row=mysqli_fetch_array($r))
                {
                    echo "<div class=app-figure id=zoom-fig>
        ...
        {
            $r=mysqli_query($conn,"select * from fur where Fnm='bed' and Ftype='queen' and Ftnm='gray' and Fcolor='red'");
            if($r)
            {
                $var= "<br><br><br><label><input type='radio' name='ccolor' value='1'><img src=images/a23.jpg></label>
                <label><input type='radio' name='ccolor' value='2'><img src=images/a57.jpg></label>
