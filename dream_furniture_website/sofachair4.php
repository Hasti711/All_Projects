...
<body><?php
$r=mysqli_query($conn,"select * from fur where Fnm='Sofa' and Ftype='Sofa chair' and Ftnm='tegan' and Fcolor='lb'");
            if($r)
            {
...
<br><br><pre class="ds">
<h3>TEGAN</h3>
   <h5> Graceful lines and smart tailoring team up in the Tegan custom accent chair. A trio of curves arc around the back and cascade down the arms, whose downward slope mimics the waterfall effect<br>of the rounded seat cushion. These curves are further highlighted by a subtle seam that begins at the crook of the arm<br>and wraps around to the back of the sofa. Surprising details, such as tiny arm pleats, keep the design from feeling too serious.

Tegan is more than just form; it’s functional, too, and that function is feeling comfortable. The tight seat and back provide support, but has just enough give to let you sink in and relax.<br>For extra lounge-ability, add an ottoman and some throw pillows, or simply kick back as-is—Tegan looks equally chic in both minimal and maximal spaces.<h5>
</pre>
<?php
