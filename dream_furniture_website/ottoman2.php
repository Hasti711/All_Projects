...
function color()
{
    ...
    {
            $var= "<br><br><br><label><input type='radio' name='ccolor' value='1' checked><img src=images/a9.jpg></label>
        ...
        $r=mysqli_query($conn,"select * from fur where Fnm='Sofa' and Ftype='Ottoman' and Ftnm='oliver' and Fcolor='red'");
        if($r)
        {
    ...
    else
    {
        ...
        {
            $r=mysqli_query($conn,"select * from fur where Fnm='Sofa' and Ftype='Ottoman' and Ftnm='oliver' and Fcolor='gold'");
            if($r)
            {
                $var= "<br><br><br><label><input type='radio' name='ccolor' value='1'><img src=images/a9.jpg></label>
                <label><input type='radio' name='ccolor' value='2' checked><img src=images/a24.jpg></label>
                <label><input type='radio' name='ccolor' value='3'><img src=images/a.jpg></label>";
                while($row=mysqli_fetch_array($r))
                {
                    echo "<div class=app-figure id=zoom-fig>
        ...
        {
            $r=mysqli_query($conn,"select * from fur where Fnm='Sofa' and Ftype='Ottoman' and Ftnm='oliver' and Fcolor='White'");
            if($r)
            {
                $var= "<br><br><br><label><input type='radio' name='ccolor' value='1'><img src=images/a9.jpg></label>
                <label><input type='radio' name='ccolor' value='2'><img src=images/a24.jpg></label>
