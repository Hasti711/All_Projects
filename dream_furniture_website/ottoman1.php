...
function color()
{
    ...
    {
            $var= "<br><br><br><label><input type='radio' name='ccolor' value='1' checked><img src=images/a2.jpg></label>
            <label><input type='radio' name='ccolor' value='2'><img src=images/a48.jpg></label>
            <label><input type='radio' name='ccolor' value='3'><img src=images/a3.jpg></label>";
        $r=mysqli_query($conn,"select * from fur where Fnm='Sofa' and Ftype='Ottoman' and Ftnm='owens' and Fcolor='red'");
        if($r)
        {
    ...
    else
    {
        ...
        {
            $r=mysqli_query($conn,"select * from fur where Fnm='Sofa' and Ftype='Ottoman' and Ftnm='owens' and Fcolor='Black'");
            if($r)
            {
                $var= "<br><br><br><label><input type='radio' name='ccolor' value='1'><img src=images/a2.jpg></label>
                <label><input type='radio' name='ccolor' value='2' checked><img src=images/a48.jpg></label>
                <label><input type='radio' name='ccolor' value='3'><img src=images/a3.jpg></label>";
                while($row=mysqli_fetch_array($r))
                {
                    echo "<div class=app-figure id=zoom-fig>
        ...
        {
            $r=mysqli_query($conn,"select * from fur where Fnm='Sofa' and Ftype='Ottoman' and Ftnm='owens' and Fcolor='Green'");
            if($r)
            {
                $var= "<br><br><br><label><input type='radio' name='ccolor' value='1'><img src=images/a2.jpg></label>
                <label><input type='radio' name='ccolor' value='2'><img src=images/a48.jpg></label>
