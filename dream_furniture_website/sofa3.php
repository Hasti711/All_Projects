...
<center><?php echo "<h3>JASPER</h3>"; echo color(); ?><br>
...
Medium & Extra Deep depths at 24” & 36”
Product Description
Like the perfect pair of relaxed-fit jeans, the Jasper custom sofa combines comfort and style. We consider it our ultimate lounging sofa. In fact, it's got the deepest seat of any of our sofas, inviting<br>you to sit back — way back. Clean lines, including a simple, solid wood rail, keep the overall design sleek with a hint of California-cool.

The sofa cushions are a layered mix of high-density foam and down feathers, so they will retain their shape over a lifetime of entertaining, lounging, and relaxing into the occasional afternoon nap.<br>With so many configuration options, the possibilities are endless. Call or email our team to customize your perfect Jasper.
...
function color()
{
    ...
    if(!isset($_POST['change']))
    {
            ...
            <label><input type='radio' name='ccolor' value='2'><img src=images/a24.jpg></label>
            <label><input type='radio' name='ccolor' value='3'><img src=images/a23.jpg></label>";
        $r=mysqli_query($conn,"select * from fur where Fnm='Sofa' and Ftype='Sofa' and Ftnm='jasper' and Fcolor='White'");
        if($r)
        {
    ...
    else
    {
        ...
        {
            $r=mysqli_query($conn,"select * from fur where Fnm='Sofa' and Ftype='Sofa' and Ftnm='jasper' and Fcolor='Gold'");
            if($r)
            {
                $var= "<br><br><br><h3>To Choose Color click on it and then click on submit<br><br></h3><label><input type='radio' name='ccolor' value='1' checked><img src=images/a.jpg></label>
            <label><input type='radio' name='ccolor' value='2'><img src=images/a24.jpg></label>
        ...
        {
            $r=mysqli_query($conn,"select * from fur where Fnm='Sofa' and Ftype='Sofa' and Ftnm='jasper' and Fcolor='Blue'");
            if($r)
            {
                $var= "<br><br><br><h3>To Choose Color click on it and then click on submit<br><br></h3><label><input type='radio' name='ccolor' value='1' checked><img src=images/a.jpg></label>
            <label><input type='radio' name='ccolor' value='2'><img src=images/a24.jpg></label>
