...
<div class="app-figure" id="zoom-fig">
        <a id="spin-1" class="Magic360" data-options="rows: 4; columns: 12"
            href="images/Home/Living/Sofa/Sectional/m1/maxwell1-01-01.png"
        ><img src="images/Home/Living/Sofa/Sectional/m1/maxwell1-01-01.png"></a>
    </div>
...
mysqli_select_db($conn,"df");

$sql1="select fid,fimg from fur where fid='2'";
