...
<?php echo "<h3>CHARLY</h3>"; echo color(); ?>
...
<h3>CHARLY</h3>
<h5>
Charly marks our first collaboration with Chris and Julia Marcum, founders of popular home design blog Chris Loves Julia. The result is an accent chair that balances beautiful design with<br>family-first function. Clean lines, including slim track arms and box cushions, create an elegant profile that appeals to adult tastes.

At the same time, Charly (named after the Marcum’s beloved late Saint Pyrenees) was designed with family comfort in mind. The seat is deep and lounge-y, and lumbar pillows provide back support.
...
function color()
{
    ...
    {
            $var= "<input type='radio' name='ccolor' value='1' checked>Black
            <input type='radio' name='ccolor' value='2'>Brown
            <input type='radio' name='ccolor' value='3'>Red";
        $r=mysqli_query($conn,"select * from fur where Fnm='Sofa' and Ftype='Sofa chair' and Ftnm='charly' and Fcolor='Black'");
        if($r)
        {
    ...
    else
    {
        ...
        {
            $r=mysqli_query($conn,"select * from fur where Fnm='Sofa' and Ftype='Sofa chair' and Ftnm='charly' and Fcolor='Brown'");
            if($r)
            {
                $var= "<input type='radio' name='ccolor' value='1'>Black
                <input type='radio' name='ccolor' value='2' checked>Brown
                <input type='radio' name='ccolor' value='3'>Red";
                while($row=mysqli_fetch_array($r))
                {
                    echo "<div class=app-figure id=zoom-fig>
        ...
        {
            $r=mysqli_query($conn,"select * from fur where Fnm='Sofa' and Ftype='Sofa chair' and Ftnm='charly' and Fcolor='Red'");
            if($r)
            {
                $var= "<input type='radio' name='ccolor' value='1'>Black
                <input type='radio' name='ccolor' value='2'>Brown
                <input type='radio' name='ccolor' value='3' checked>Red";
                while($row=mysqli_fetch_array($r))
                {
                    echo "<div class=app-figure id=zoom-fig>
            <a id=spin-1 class=Magic360 data-options=rows: 4; columns: 12
