...
<center><?php echo "<h3>Corner Sloan<br></h3>"; echo color(); ?><br>
...
<br><br><pre class="ds">
    <h3>Seat comfort:</h3><h5>
Soft seat
Extra-soft cushion available. Contact us to order.
...
Medium depth at 24”
Product Description
Sloan strikes an ideal balance between sleek and soft. Take, for instance, the crisp lines of its track arm, which are offset by a subtle taper near the back. The Sloan custom sectional sofa reflects<br> a modern influence, yet is approachable and livable. It's no wonder it feels right in a variety of decors, whether modern or more traditional.

Sloan's sit profile only adds to the universal appeal. With a medium height and depth, it's a sectional sofa that suits a range of body types. The layered cushion is soft, yet supportive,<br> and <br>can be upgraded for an extra-soft sit.</h5>
</pre>
<br><br>
<br><br><center><h3>Also Available</h3><br><br>
<a href="cso.php" class="lc">Ottoman <br><img src="images/Home/Living/Sofa/Ottoman/o25/s41-01-01.png"></a></center>
<?php
function color()
{
    include 'conn/conn.php';
    if(!isset($_POST['change']))
    {
            ...
            <label><input type='radio' name='ccolor' value='3'><img src=images/a13.jpg></label>";
        $r=mysqli_query($conn,"select * from fur where Fnm='Sofa' and Ftype='Sectional' and Ftnm='corner sloan' and Fcolor='White'");
        if($r)
        {
    ...
    else
    {
        ...
        if($c==1)
        {
            ...
            if($r)
            {
                $var= "<br><br><br><h3>To Choose Color click on it and then click on submit<br><br></h3><input type='radio' name='ccolor' value='1' checked><img src=images/a.jpg></label>
                <label><input type='radio' name='ccolor' value='2'><img src=images/a2.jpg></label>
                <label><input type='radio' name='ccolor' value='3'><img src=images/a13.jpg></label>";
                while($row=mysqli_fetch_array($r))
                {
        ...
        {
            $r=mysqli_query($conn,"select * from fur where Fnm='Sofa' and Ftype='Sectional' and Ftnm='corner sloan' and Fcolor='red'");
            if($r)
            {
        ...
        {
            $r=mysqli_query($conn,"select * from fur where Fnm='Sofa' and Ftype='Sectional' and Ftnm='corner sloan' and Fcolor='Gray'");
            if($r)
            {
                $var= "<br><br><br><h3>To Choose Color click on it and then click on submit<br><br></h3><label><input type='radio' name='ccolor' value='1'><img src=images/a.jpg></label>
                <label><input type='radio' name='ccolor' value='2'><img src=images/a2.jpg></label>
                <label><input type='radio' name='ccolor' value='3' checked><img src=images/a13.jpg></label>";
                while($row=mysqli_fetch_array($r))
                {
                    echo "<div class=app-figure id=zoom-fig>
            <a id=spin-1 class=Magic360 data-options=rows: 4; columns: 12
