...
The inspiration for Maxwell "was to take a traditional shape and make it fresh," says Apartment Therapy founder Maxwell Ryan, who co-created the design with us. That means you'll enjoy a custom sectional sofa <br>that's "comfy, cozy, and approachable," with thick, contoured arms and piping details. At the same time, the slipcovered sectional remains light and airy thanks to a thinner frame rail and turned leg.

Maxwell's low profile and luxuriously deep seat invite you to sit back and relax. Reversible seat cushions constructed from our softest resilient foam and topped with extra-soft down feathers might make it <br>hard to get up.
</pre>
<br><br>
<center><form action="proc/addp.php"><button type="submit">Add to Bucket</button></form><br><br>
<?php
function color()
{
    include 'conn/conn.php';
    ...
    {
            $var= "<br><br><br><label><input type='radio' name='ccolor' value='1' checked><img src=images/a.jpg></label>
        ...
        $r=mysqli_query($conn,"select * from fur where Fnm='Sofa' and Ftype='Sofa' and Ftnm='Maxwell sill covered' and Fcolor='White'");
        if($r)
        {
    ...
    else
    {
        ...
        {
            $r=mysqli_query($conn,"select * from fur where Fnm='Sofa' and Ftype='sofa' and Ftnm='Maxwell sill covered' and Fcolor='black'");
            if($r)
            {
                $var= "<br><br><br><label><input type='radio' name='ccolor' value='1'><img src=images/a.jpg></label>
        ...
        {
            $r=mysqli_query($conn,"select * from fur where Fnm='Sofa' and Ftype='sofa' and Ftnm='Maxwell sill covered' and Fcolor='red'");
            if($r)
            {
                $var= "<br><br><br><label><input type='radio' name='ccolor' value='1'><img src=images/a.jpg></label>
                <label><input type='radio' name='ccolor' value='2'><img src=images/a20.jpg></label>
