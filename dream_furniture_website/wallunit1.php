...
<div class="w3-display-container mySlides">
  <img src="<?php
$sql1="select * from fur where ftype='wu2' && ftnm='wu1'";
$r=mysqli_query($conn,$sql1);
if($r)
{
	$row=mysqli_fetch_array($r);
...
<div class="w3-display-container mySlides">
  <img src="<?php
$sql1="select * from fur where ftype='wu4' && ftnm='wu1'";
$r=mysqli_query($conn,$sql1);
if($r)
{
	$row=mysqli_fetch_array($r);
...
<div class="w3-display-container mySlides">
  <img src="<?php
$sql1="select * from fur where ftype='wu5' && ftnm='wu1'";
$r=mysqli_query($conn,$sql1);
if($r)
{
	$row=mysqli_fetch_array($r);
...
<div class="w3-display-container mySlides">
  <img src="<?php
$sql1="select * from fur where ftype='wu6' && ftnm='wu1'";
$r=mysqli_query($conn,$sql1);
if($r)
{
	$row=mysqli_fetch_array($r);
...
<div class="w3-display-container mySlides">
  <img src="<?php
$sql1="select * from fur where ftype='wu7' && ftnm='wu1'";
$r=mysqli_query($conn,$sql1);
if($r)
{
	$row=mysqli_fetch_array($r);
...
<div class="w3-display-container mySlides">
  <img src="<?php
$sql1="select * from fur where ftype='wu8' && ftnm='wu1'";
$r=mysqli_query($conn,$sql1);
if($r)
{
	$row=mysqli_fetch_array($r);
