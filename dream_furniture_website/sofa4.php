...
<?php echo "<h3>CATLIN BY EVERYGIRL</h3>"; echo color(); ?>
...
Medium depth at 22”
Product Description
Designed in collaboration with The Everygirl, the Caitlin custom sofa brings a touch of romance to any room. Its allure lies in details like piped seams, lumbar cushions, and tapered arms with soft<br>pleating. These are matched with an otherwise clean profile, creating a piece that "fits as perfectly in a casual apartment as it does a formal living space," according to The Everygirl Founders<br>Alaina and Danielle.

“Named for our very first intern, Caitlin Timson, who was a huge help when we began in 2012, Caitlin is our take on the classic club sofa, with super soft seat and back cushions that you can melt<br>into," say Alaina and Danielle. Indeed, its fully reversible bench cushion is made with soft, high-resilience foam wrapped in down, and its back cushions are constructed with a soft poly-down fill<br>that allows you to fully sink in.
...
function color()
{
    ...
    {
            $var= "<input type='radio' name='ccolor' value='1' checked>Gray
            <input type='radio' name='ccolor' value='2'>Black
            <input type='radio' name='ccolor' value='3'>Blue";
        $r=mysqli_query($conn,"select * from fur where Fnm='Sofa' and Ftype='Sofa' and Ftnm='Catlin by everygirl' and Fcolor='Gray'");
        if($r)
        {
    ...
    else
    {
        ...
        {
            $r=mysqli_query($conn,"select * from fur where Fnm='Sofa' and Ftype='Sofa' and Ftnm='Catlin by everygirl' and Fcolor='Black'");
            if($r)
            {
                $var= "<input type='radio' name='ccolor' value='1'>Gray
                <input type='radio' name='ccolor' value='2' checked>Black
                <input type='radio' name='ccolor' value='3'>Blue";
                while($row=mysqli_fetch_array($r))
                {
                    echo "<div class=app-figure id=zoom-fig>
        ...
        {
            $r=mysqli_query($conn,"select * from fur where Fnm='Sofa' and Ftype='Sofa' and Ftnm='Catlin by everygirl' and Fcolor='Blue'");
            if($r)
            {
                $var= "<input type='radio' name='ccolor' value='1'>Gray
                <input type='radio' name='ccolor' value='2'>Black
                <input type='radio' name='ccolor' value='3' checked>Blue";
                while($row=mysqli_fetch_array($r))
                {
                    echo "<div class=app-figure id=zoom-fig>
            <a id=spin-1 class=Magic360 data-options=rows: 4; columns: 12
