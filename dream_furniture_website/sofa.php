...
<div class="_1HmYoV _35HD7C" style="flex-grow: 1;
    overflow: auto">
  	...
  	<tr>
		<td>
<a href="sofa1.php" class="lc">
			<div class="flex-container">
			<div style="flex-grow: 1"> <img src="<?php
$sql1="select * from fur where ftype='sofa' && ftnm='owens' && fcolor='Lb'";
...
?>
		...
		<td><a href="sofa2.php" class="lc">
			<div class="flex-container">
			<div style="flex-grow: 1"> <img src="<?php
$sql1="select * from fur where ftype='sofa' && ftnm='oliver' && fcolor='gray'";
$r=mysqli_query($conn,$sql1);
if($r)
{
...
?>
	...
	<tr><td><a href="sofa3.php" class="lc">
			<div class="flex-container">
			<div style="flex-grow: 1"> <img src="<?php
$sql1="select * from fur where ftype='sofa' && ftnm='jasper' && fcolor='white'";
$r=mysqli_query($conn,$sql1);
if($r)
{
	while ($row=mysqli_fetch_array($r)) {
...
if($r)
{
	...
	<td><a href="sofa4.php" class="lc">
			<div class="flex-container">
			<div style="flex-grow: 1"> <img src="<?php
$sql1="select * from fur where ftype='sofa' && ftnm='catlin by everygirl' && fcolor='gray'";
$r=mysqli_query($conn,$sql1);
if($r)
{
	while ($row=mysqli_fetch_array($r)) {
