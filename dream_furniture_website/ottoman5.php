...
function color()
{
    ...
    if(!isset($_POST['change']))
    {
            ...
            <input type='radio' name='ccolor' value='2'>Red
            <input type='radio' name='ccolor' value='3'>Light Black";
        $r=mysqli_query($conn,"select * from fur where Fnm='Sofa' and Ftype='Ottoman' and Ftnm='charly' and Fcolor='Brown'");
        if($r)
        {
    ...
    else
    {
        ...
        if($c==1)
        {
            ...
            if($r)
            {
                $var= "<input type='radio' name='ccolor' value='1' checked>Brown
                <input type='radio' name='ccolor' value='2'>Red
                <input type='radio' name='ccolor' value='3'>Light Black";
                while($row=mysqli_fetch_array($r))
                {
        ...
        {
            $r=mysqli_query($conn,"select * from fur where Fnm='Sofa' and Ftype='Ottoman' and Ftnm='charly' and Fcolor='Red'");
            if($r)
            {
                $var= "<input type='radio' name='ccolor' value='1'>Brown
                <input type='radio' name='ccolor' value='2' checked>Red
                <input type='radio' name='ccolor' value='3'>Light Black";
                while($row=mysqli_fetch_array($r))
                {
                    echo "<div class=app-figure id=zoom-fig>
        ...
        {
            $r=mysqli_query($conn,"select * from fur where Fnm='Sofa' and Ftype='Ottoman' and Ftnm='charly' and Fcolor='lb'");
            if($r)
            {
                $var= "<input type='radio' name='ccolor' value='1'>Brown
                <input type='radio' name='ccolor' value='2'>Red
                <input type='radio' name='ccolor' value='3' checked>Light Black";
                while($row=mysqli_fetch_array($r))
                {
                    echo "<div class=app-figure id=zoom-fig>
            <a id=spin-1 class=Magic360 data-options=rows: 4; columns: 12
