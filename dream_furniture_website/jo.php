...
<center><?php echo "<h3>Jason Wu</h3> <br>";echo color(); ?><br>
...
function color()
{
    ...
    {
            $var= "<br><br><br><h3>To Choose Color click on it and then click on submit<br><br></h3><label><input type='radio' name='ccolor' value='1' checked><img src=images/a59.jpg></label>
        ...
        $r=mysqli_query($conn,"select * from fur where Fnm='Sofa' and Ftype='Ottoman' and Ftnm='jason wu' and Fcolor='offwhite'");
        if($r)
        {
    ...
    else
    {
        ...
        {
            $r=mysqli_query($conn,"select * from fur where Fnm='Sofa' and Ftype='Ottoman' and Ftnm='jason wu' and Fcolor='white'");
            if($r)
            {
                $var= "<br><br><br><h3>To Choose Color click on it and then click on submit<br><br></h3><label><input type='radio' name='ccolor' value='1'><img src=images/a59.jpg></label>
        ...
        {
            $r=mysqli_query($conn,"select * from fur where Fnm='Sofa' and Ftype='Ottoman' and Ftnm='jason wu' and Fcolor='red'");
            if($r)
            {
                $var= "<br><br><br><h3>To Choose Color click on it and then click on submit<br><br></h3><label><input type='radio' name='ccolor' value='1'><img src=images/a59.jpg></label>
                <label><input type='radio' name='ccolor' value='2'><img src=images/a.jpg></label>
