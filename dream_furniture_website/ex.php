...
<style type="text/css">
    ...
    .wizard-settings a { color: #chaircolor9933; }
...
<script>
    ...
    function copyToClipboard(src) {
        ...
        try {
            suchaircoloress = document.exechaircolorommand('copy');
        } catch(err) {
            suchaircoloress = false;
        }
...
<body>
    ...
    <!--<div>
        <form action="<?php $_PHP_SELF ?>" method="GET">
            <input type="radio" onclick="ex()" name="chaircolor" value="1">ore<br/>
            <input type="radio" onclick="ex()" name="chaircolor" value="2">ruby<br/>
            <input type="radio" onclick="ex()" name="chaircolor" value="3">gold<br/>
            <<input type="submit" name="submit" value="show">
            action="<?php $_PHP_SELF ?>" method="get"
        </form>-->
        <form action="<?php $_PHP_SELF ?>" method="post">
          <?php  echo chcolor(); ?>
            <!-- <select name="chaircolor">
...
// function name_click(){
//   value_select = $("#chaircolor").val();
//   document.write(value_select);
//   $.POST('chair1.php',{chaircolor:value_select},function(data){
//      alert('done')
//  });
//id="chaircolor"
// }
...
$('#chaircolor').change(function(){
    var value_select = $("#chaircolor").val();
  // document.write(value_select);
  $.ajax({
    url:'test.php',
    method: "post",
    data: {chaircol0:value_select},
    suchaircoloress:function(data){
        // alert(data);
        // console.log();
        $('#chaircolor').html(data);    
    }
  });
...
<?php
function chcolor(){
$con = mysqli_connect("localhost","root","","df1");

if(isset($_POST['chaircolor'])){
        $chaircolor=$_POST['chaircolor'];
    }
if(!isset($_POST['change']))
{

 $result=mysqli_query($con,"select * from fur where Ftnm='andrew' AND Fcolor='ore'");
...
$var= "<input type='radio' name='chaircolor' value='1' checked>ore
            <input type='radio' name='chaircolor' value='2'>ruby
            <input type='radio' name='chaircolor' value='3'>gold";     
}
    else
    {
        if($chaircolor==1)      
        ...
        else if($chaircolor==2)     
        {           
           $result=mysqli_query($con , "select * from fur where Ftnm='andrew' && Fcolor='ruby'");
           /*while($row = mysqli_fetch_array($result))
           {
                echo "<div class=app-figure id=zoom-fig>
                     <a id=spin-1 class=Magic360 data-options=rows: 4; columns: 12
           ...
           $var= "<input type='radio' name='chaircolor' value='1'>ore
            <input type='radio' name='chaircolor' value='2' checked>ruby
            <input type='radio' name='chaircolor' value='3'>gold";     
        ...
        else
        {
           ...
           $result=mysqli_query($con, "select * from fur where Ftnm='andrew' && Fcolor='gold'");
           /*while($row = mysqli_fetch_array($result))
           {
                echo "<div class=app-figure id=zoom-fig>
                     <a id=spin-1 class=Magic360 data-options=rows: 4; columns: 12
            ...
            $var= "<input type='radio' name='chaircolor' value='1'>ore
            <input type='radio' name='chaircolor' value='2'>ruby
            <input type='radio' name='chaircolor' value='3' checked>gold";     
