...
<div class="_1HmYoV _35HD7C" style="flex-grow: 1; overflow: auto">
  	...
  	<tr>
		<td>
<a href="bed1.php" class="lc">
			<div class="flex-container">
			<div style="flex-grow: 1"> <img src="<?php
$sql1="select * from fur where ftype='queen' && ftnm='harper' && fcolor='blue'";
...
?>
		...
		<td><a href="bed2.php" class="lc">
			<div class="flex-container">
			<div style="flex-grow: 1"> <img src="<?php
$sql1="select * from fur where ftype='queen' && ftnm='oliver' && fcolor='blush'";
$r=mysqli_query($conn,$sql1);
if($r)
{
...
<td><a href="bed3.php" class="lc">
			<div class="flex-container">
			<div style="flex-grow: 1"> <img src="<?php
$sql1="select * from fur where ftype='queen' && ftnm='gray' && fcolor='black'";
$r=mysqli_query($conn,$sql1);
if($r)
{
	while ($row=mysqli_fetch_array($r)) {
