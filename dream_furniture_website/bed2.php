...
function color()
{
    ...
    {
            $var= "<br><br><br><label><input type='radio' name='ccolor' value='1' checked><img src=images/a50.jpg></label>
            <label><input type='radio' name='ccolor' value='2'><img src=images/a54.jpg></label>
            <label><input type='radio' name='ccolor' value='3'><img src=images/a48.jpg></label>";
        $r=mysqli_query($conn,"select * from fur where Fnm='Bed' and Ftype='queen' and Ftnm='oliver' and Fcolor='blush'");
        if($r)
        {
    ...
    else
    {
        ...
        {
            $r=mysqli_query($conn,"select * from fur where Fnm='bed' and Ftype='queen' and Ftnm='oliver' and Fcolor='gray'");
            if($r)
            {
                $var= "<br><br><br><label><input type='radio' name='ccolor' value='1'><img src=images/a50.jpg></label>
                <label><input type='radio' name='ccolor' value='2' checked><img src=images/a54.jpg></label>
                <label><input type='radio' name='ccolor' value='3'><img src=images/a48.jpg></label>";
                while($row=mysqli_fetch_array($r))
                {
                    echo "<div class=app-figure id=zoom-fig>
        ...
        {
            $r=mysqli_query($conn,"select * from fur where Fnm='bed' and Ftype='queen' and Ftnm='oliver' and Fcolor='Black'");
            if($r)
            {
                $var= "<br><br><br><label><input type='radio' name='ccolor' value='1'><img src=images/a50.jpg></label>
                <label><input type='radio' name='ccolor' value='2'><img src=images/a54.jpg></label>
                <label><input type='radio' name='ccolor' value='3' checked><img src=images/a48.jpg></label>";
                while($row=mysqli_fetch_array($r))
                {
                    echo "<div class=app-figure id=zoom-fig>
            <a id=spin-1 class=Magic360 data-options=rows: 4; columns: 12
