				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--iris">
						<ul class="nav navbar-nav menu__list">
							...
							<li class="menu__item menu__item--current"><a href="rj_regi.php" class="menu__link">RJ Registration</a></li>
		...
		<div class="container">
			<div class="w3l_breadcrumbs_left">
				<ul>
					...
					<li>RJ Registration</li>
				</ul>
			</div>
			<div class="w3_agile_breadcrumbs_right">
				<h2>Rj Registration</h2>
			</div>
...
<!-- music -->
	<div class="about w3_music">
		<div class="container">
			<h3 class="agileits_w3layouts_head">Registration of <span>RJ</span> Schedule</h3>
