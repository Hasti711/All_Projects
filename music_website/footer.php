	<div class="footer">
		<div class="container">
			<div class="col-md-4 agileinfo_footer_grid">
				<h3>About Us</h3>
				<p>Music is a part of all of our lives, from when we’re growing up to when we’re old. We grow up to the sound of our mothers singing us lullabies so that we’d go to sleep.</p>
	...
	<div class="w3agile_copy_right">
		<div class="container">
			 <p>© 2021 Music Magic. All Rights Reserved</a></p>
		</div>
	</div>
</body>
</html>