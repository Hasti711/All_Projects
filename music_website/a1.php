				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--iris">
						<ul class="nav navbar-nav menu__list">
							...
							<!-- <li class="dropdown menu__item menu__itemcurrent">
								<a href="acc.php" class="dropdown-toggle menu__link" data-toggle="dropdown">Account<b class="caret"></b></a> -->
								<!-- <ul class="dropdown-menu agile_short_dropdown">
									<li><a href="a1.php">Sign up</a></li>
									<li><a href="a2.php">Login</a></li>
								</ul> -->
							<!-- </li> -->
...
<div class="latest-albums">
		<div class="container">
			<h3 class="agileits_w3layouts_head">Join with <span>Music Magic</span></h3>
			...
			<div class="wthree_latest_albums_grids gallery">
				<div class="col-md-8 agile_mail_grid_left">
					<form action="sp.php" method="post">
						...
						<input type="text" name="Password" placeholder="Password" required="" maxlength="8"><br><br><br>
				...
				<div class="col-md-4 w3_agileits_mail_grid_right">
					<div class="wthree_mail_grid_right">
						...
						<ul class="agileinfo_phone_mail">
							...
							<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i>Email: <a href="music_magic@gmail.com">music_magic@gmail.com</a></li>
						</ul>
