		...
		<div class="container">
			...
			<div class="wthree_latest_albums_grids gallery">
				<div class="col-md-8 agile_mail_grid_left">
					<form method="post" name="mail_form" id="mailform" action="mailp.php">
						<input type="text" name="Name" placeholder="Name" required="" id="nm">
						<input type="email" name="Email" placeholder="Email" required="" id="em">
						<input type="text" name="Subject" placeholder="Subject" required="">
						<textarea name="Message" placeholder="Your message here..." required="" id="msg"></textarea>
						<input type="submit" value="Mail Us Now" name="mail">
					</form>
				</div>
