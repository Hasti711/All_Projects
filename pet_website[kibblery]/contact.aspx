			...
			<div class="contact-agileinfo">
				<div class="col-md-7 contact-right">
					<form id="formcon" runat="server">
						...
						<input type="text" name="Subject" id="sub" placeholder="Subject" runat="server" required="" />
						<textarea name="Message" id="msg" placeholder="Message" runat="server" required=""></textarea>
						<input type="submit" id="con" value="SUBMIT" runat="server" onserverclick="con_click" />
					</form>
				</div>
