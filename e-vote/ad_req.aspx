<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ad_req.aspx.cs" Inherits="Project_SDP.ad_req" %>
...
<body style="margin:0;">
    ...
    <a href="ad_result.aspx" style="margin-left:80px;" >Result</a></div>
        <table runat="server" id="tbl1" style="margin-left:173px;border:1px solid; width:1150px;">
        <th>
            Name
        </th>
    ...
    <form id="form2" runat="server" style="margin-left:173px;background-color:white;width:1150px;">
		...
		<input type="text" id="ass_no1_1" runat="server" style="height:25px;width:115px;" placeholder="City" required="" />
		<img src="#" id="election_card_1" runat="server" required="" />
		...
		<input id="Submit1_1" runat="server" onserverclick="ad_aprv" type="submit" value="Approve"/>
    </form>
